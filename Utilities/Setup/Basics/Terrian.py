...
"""
	...
	Groups: [[NIMHlabs_(group)]], [[Spectrum_Labs_(group)]], 
	 [[Monster_Academy_(group)]], [[Team_Temporal_(group)]]
	Creation: 3176-2-??

	The '''Terrian Setup''' utility is for the purpose of creating a 
	database that contains battle based field effects, various battle 
	terrians of different varients of challenges.
	...
	{{modified|made comments more pythonic}}
...
"""
	...
	name: what to call the effect (eg: Rain, Hail, Sunshine, Sandstorm, Night, 
        ...
        House, Shadow Sky, Acid Rain--generally making this easier to expand)
